...
1. Перейдите в раздел **[Releases]([https://github.com](https://github.com/loanelly/OP-Bh-helper-for-CS2/releases))** на этом гитхабе.
2. Скачайте архив актуальной версии `v1.0.0`.
3. Распакуйте в любое место и запускайте `OP_Bh_helper.exe` **от имени Администратора**. 
...
* Нашли баг или хотите предложить фичу? Открывайте **[Issues](https://github.com)**.
...
<p align="center">
  Сделано с ❤️ руками <a href="https://github.com">loanelly</a>.
</p>
